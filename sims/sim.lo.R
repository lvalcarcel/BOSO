...
reg.funs = list()
reg.funs[["Lasso"]] = function(x,y,xval,yval) lasso(x,y,intercept=FALSE,nlam=50)
...
reg.funs[["BOSO - AIC"]] = function(x,y,xval,yval) BOSO(x,y, xval, yval, IC = "AIC", nlambda=50,intercept=FALSE, standardize = F)
reg.funs[["BOSO - BIC"]] = function(x,y,xval,yval) BOSO(x,y, xval, yval, IC = "BIC", nlambda=50,intercept=FALSE, standardize = F)
reg.funs[["BOSO - eBIC"]] = function(x,y,xval,yval) BOSO(x,y, xval, yval, IC = "eBIC", nlambda=50,intercept=FALSE, standardize = F)
